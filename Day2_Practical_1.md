...
## Part I: SmartSeq2: Customised Pipeline running with aligner Hisat2 (Similar to bulk RNASeq)
...
8. **View the summary report for FCA7167219: web_summary.html** <br> <br>
...
10. **Visualise the output: Basic QC with web_summary.html file (Practical_day2/Cellranger_Reports)
...
### Exercise 1: Basic QC with web_summary.html file (Practical_day2/Cellranger_Reports)
General Question: which web_summary.html files are good? If they are not good, why is this?
...
* If you add the option in your count pipeline --expect-cells 1000, what does the barcode rank plot looks like? How about the other summary?
* Does the coverage variation affect your data?
* If your cells vary, does the 'reads per cell' quantity make sense?
* Which genes are differentially expressed according to different reports?
...
* If we change the aggr pipeline option --normalize from "none" to default "mapped", what happens to the count matrix?
...
10. **Run an nf-core/smartseq2 test**  
...
**If you had a HPC singularity container** then take Home Run
```perl
